        ...
        <div className="container">
          <ul className="nav d-flex justify-content-center" role="tablist" data-aos="fade-up" data-aos-delay={100}>
            <li className="nav-item" role="presentation">
              <a className="nav-link active show" data-bs-toggle="tab" data-bs-target="#menu-appetizer"  aria-selected="true"
                                     role="tab">
                <h4>Khai vị</h4>
              </a>
            </li>
            ...
            <li className="nav-item">
              <a className="nav-link" data-bs-toggle="tab" data-bs-target="#menu-spicy" role="tab" aria-selected="true"
                tabIndex={0}>
                <h4>Mì Cay</h4>
              </a>
              {/* End tab nav item */}
            ...
            <li className="nav-item">
              <a className="nav-link" data-bs-toggle="tab" data-bs-target="#menu-hotpot" aria-selected="false"
            ...
            {/* End tab nav item */}
            <li className="nav-item">
              <a className="nav-link" data-bs-toggle="tab" data-bs-target="#menu-drink">
                <h4>Đồ uống</h4>
              </a>
            </li>
            {/* End tab nav item */}
            ...
            <div className="tab-pane fade active show" id="menu-appetizer" role="tabpanel">
              ...
              <div className="row gy-5">
                {menuData
                  ...
                  .map((item, index) => (
                    <div key={item.id || index} className="col-lg-4 menu-item">
            ...
            <div className="tab-pane fade" id="menu-spicy" role="tabpanel">
              ...
              <div className="row gy-5">
                {menuData
                  ...
                  .map((item) => (
                    <div key={item.id} className="col-lg-4 menu-item">
                      <a href={item.image} className="glightbox">
